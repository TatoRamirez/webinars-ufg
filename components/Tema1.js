    ...
    <div className="container">
      ...
      <div data-test="row" className="row">
        <div data-test="col" className="col-12 col-md-6">
          <div className="p-5 p-md-3 animate__animated animate__fadeInLeft wow">
            <img src="images/RegistroBannerSuperior.jpg" className="img-info" />
          </div>
        </div>

        <div data-test="col" className="col-12 col-md-6">
          <div className="p-5 p-md-3 text-justify">
            <p className="tam-info animate__animated animate__fadeInRight wow">
            ...
            <ul className="info-li inform-list animate__animated animate__fadeInRight animate__delay-1s wow">
              <li>
                <span>-</span>
